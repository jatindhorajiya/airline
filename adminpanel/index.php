...
$db->where('b_status', 'CANCELLED');
$cancel = $db->getValue ("booking_details", "sum(b_price)");
            ...
            <div class="panel panel-yellow">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge"><?php echo $cancel_booked; ?></div>
                            <div>Ticket Canceled</div>
                        </div>
                    </div>
                </div>
                <a href="booking-cancel.php">
                    <div class="panel-footer">
                        <span class="pull-left">View Details</span>
                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                        <div class="clearfix"></div>
            ...
            <div class="panel panel-yellow">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge"><?php echo $cancel; ?></div>
                            <div>Canceled - total amounts</div>
                        </div>
                    </div>
                </div>
